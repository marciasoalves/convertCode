...
function btnSimples() {
    ...
    if (document.calc.querySelectorAll(".adv")[1].style.visibility == "hidden") {
        ...
        document.calc.simples.value = "Convêncional"
...
function modo_noturno() {
    for (i=0; i<document.getElementsByClassName("tela").length;i++){
        document.getElementsByClassName("tela")[i].style.color = "white"
    }
    ...
    document.getElementById("instrucoes").style.backgroundColor = "black"
}

function modo_diurno() {
    for (i=0; i<document.getElementsByClassName("tela").length;i++){
        document.getElementsByClassName("tela")[i].style.color = "black"
    }
    for (i=0; i<document.getElementsByTagName("p").length; i++){
